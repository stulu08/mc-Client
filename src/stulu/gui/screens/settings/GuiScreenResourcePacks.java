...
public class GuiScreenResourcePacks extends GuiScreen
{
    ...
    public void initGui()
    {
        this.StulubuttonList.add(new GuiOptionsButtonStulu(2, this.width / 2 - 154, this.height - 48, I18n.format("resourcePack.openFolder", new Object[0])));
        this.StulubuttonList.add(new GuiOptionsButtonStulu(1, this.width / 2 + 4, this.height - 48, I18n.format("gui.done", new Object[0])));
