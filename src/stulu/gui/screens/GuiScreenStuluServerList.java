...
public class GuiScreenStuluServerList extends GuiScreen
{
    private final GuiMultiplayer field_146303_a;
    private final ServerData field_146301_f;
    public ServerListEntryNormal serverListEntryNormal;
    private GuiTextField field_146302_g;

    public GuiScreenStuluServerList(GuiMultiplayer p_i1031_1_, ServerData p_i1031_2_)
    {
        this.field_146303_a = p_i1031_1_;
        this.field_146301_f = p_i1031_2_;
        serverListEntryNormal = new ServerListEntryNormal(field_146303_a,field_146301_f);
    }
    ...
    public void initGui()
    {
        ...
        String serverIp = field_146302_g.getText();
        String serverName = serverIp;
        if(serverIp.split("\\.").length != 0)
            serverName = serverIp.split("\\.")[0];
        serverListEntryNormal = new ServerListEntryNormal(field_146303_a,new ServerData(serverName,serverIp,false));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        serverListEntryNormal.drawEntry(0,this.width / 2 - 100, 66,200,50,mouseX,mouseY,false);
