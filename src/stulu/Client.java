...
public class Client {
    ...
    public String populateInfo = "0/0";
    public void init(){
        ...
        SplashProgress.setProgress(2, "Stulu - Syncing");
    ...
    public static List<String> ReadWebFile(String Website, boolean WithSpaces){
        try {
            ...
            rte.add("89a44555-8071-4411-b1cc-2d4c05364251");
            rte.add("d0f8ac24-25ef-4d91-890a-9dde737370e8");
    ...
    public void syncCosmetics(){
        ...
        Wither = Sfile.ClientINIRead.getBool("Cosmetics","wither");
    ...
    public static void setWither(boolean wither) {
        Wither = wither;
        Sfile.ClientINIWrite.save("Cosmetics","wither",""+Wither);
    }

    private void initGUIStuff(){
        ClientUsers = ReadWebFile("https://raw.githubusercontent.com/stulu08/mc-Client/main/data/premium-users",false).toArray(new String[0]);
