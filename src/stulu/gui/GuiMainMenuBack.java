...
public class GuiMainMenuBack extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        //this.backgroundTexture = new ResourceLocation("stulu/gui/spashscreen.png");
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        GlStateManager.popMatrix();
        String s = Client.getINSTANCE().getVersion();
