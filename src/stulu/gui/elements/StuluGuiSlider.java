...
public class StuluGuiSlider extends GuiButtonStulu{
    ...
    private StuluGuiSlider.FormatHelper formatHelper;

    public StuluGuiSlider(GuiPageButtonList.GuiResponder guiResponder, int idIn, int x, int y, String name, float min, float max, float defaultValue, StuluGuiSlider.FormatHelper formatter)
    {
    ...
    public StuluGuiSlider(GuiPageButtonList.GuiResponder guiResponder, int idIn, int x, int y, String name, float min, float max, float defaultValue, StuluGuiSlider.FormatHelper formatter,float z)
    {
        super(idIn, x, y, 150, 20, "");
        this.name = name;
        this.min = min;
    ...
    public StuluGuiSlider(GuiPageButtonList.GuiResponder guiResponder, int idIn, int x, int y, String name, float min, float max, float defaultValue, StuluGuiSlider.FormatHelper formatter, float z, Color color)
    {
        super(idIn, x, y, 150, 20, "");
        this.name = name;
        this.min = min;
    ...
    public StuluGuiSlider(GuiPageButtonList.GuiResponder guiResponder, int idIn, int x, int y, String name, float min, float max, float defaultValue, StuluGuiSlider.FormatHelper formatter, float z,boolean textC)
    {
        super(idIn, x, y, 150, 20, "");
        this.name = name;
        this.min = min;
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY) {
        if(rain)
            this.textColor = Client.getINSTANCE().Rainbow;
